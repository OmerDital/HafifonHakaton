  ...
  return (
    ...
    >
      ...
      <Stack direction='row' spacing={2} sx={{ margin: '24px' }}>
        <Button variant='contained' color='secondary' onClick={handleLoadAlbumOpen}>טען אלבום</Button>
        <Button variant='contained' onClick={handleCreateAlbumOpen}>צור חדש</Button>
      </Stack>
      <LoadAlbumDialog open={isLoadAlbumOpen} handleClose={handleLoadAlbumClose} />
      <CreateAlbumDialog open={isCreateAlbumOpen} handleClose={handleCreateAlbumClose} />
    </SideMenuContainer>
  );
};
